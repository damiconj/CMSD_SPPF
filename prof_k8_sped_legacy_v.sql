WITH perf_sped_n as (
		...
		WHERE TEST_TYPE IN ('OAA') 
		AND	FAY.GRADE IN ('03', '04', '05', '06', '07', '08')
...
/*
	   Name:	prof_k8_sped_legacy_v
	   Author:	Damico, Nicholas J
	   Purpose:	Query that calcualtes the Proficiency percentages by subject and year for Special Education (SPED)
